...
stdbuf -o0 -e0 python -u ~/Code/OOHabstraction/ComparerTST/comparerTST.py > /gss_gpfs_scratch/harms.n/comparerTST/AutoTST-comparer.updated.1.$SLURM_ARRAY_TASK_ID.combined.log 2>&1
