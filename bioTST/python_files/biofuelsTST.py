...
species_dict_file = os.path.expanduser('~/Code/OOHabstraction/bioTST/generate_reactions_output/chemkin/species_dictionary.txt')
species_dict = loadSpecies.getSpecies(species_dict_file)
logging.info("Species Dictionary loaded")
print species_dict

file_object = open(os.path.expanduser('~/Code/OOHabstraction/bioTST/generate_reactions_output/chemkin/chem_annotated.inp'), 'r')
